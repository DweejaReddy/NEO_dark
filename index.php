    ...
    <section class="container-fluid d-none d-lg-block" id="home">
      <div class="row">
        <div class="col-lg-5 img-fluid img-responsive showcase-left"><img class=" ml-4" src="images/NEO_spons.png" alt="" height="220px">
          ...
          <a class="btn btn-dark bg btn btn2 mt-3 mr-4 showcase-left"  href="mocktest.php" target="_blank" role="button">ATTEMPT MOCK TEST<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-right-fill" viewBox="0 0 16 16">
              <path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"/>
            </svg></a>
    ...
    <section class="container-fluid d-lg-none d-block" id="home_mob">
      ...
      <div class="text-center"><a href="https://t.me/EntreLearners" target="_blank"> 
        ...
        <li class="nav-item pt-3 text-center mb-3">
          ...
          <a class="btn btn-dark bg btn2 btn my-1" data-aos="fade-left" data-aos-duration="1000" href="images/NEO_studymaterial.pdf" target="_blank" role="button"> STUDY MATERIAL<svg xmlns="http://www.w3.org/2000/svg" width="10" height="16" fill="currentColor" class="bi bi-caret-right-fill" viewBox="0 0 16 16">
            <path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"/>
          </svg></a>
          <a class="btn btn-dark bg btn1 btn my-1" data-aos="fade-right" data-aos-duration="1000" href="mocktest.php" target="_blank" role="button"> ATTEMPT MOCK TEST<svg xmlns="http://www.w3.org/2000/svg" width="10" height="16" fill="currentColor" class="bi bi-caret-right-fill" viewBox="0 0 16 16">
            <path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"/>
          </svg></a>
