        ...
        <div class="container d-flex align-items-center justify-content-center min-vh-100">
            <div class="row text-center">
                <div class="" style="color:white;">
                  <?php echo "<h3>Dear Student,<br>Please<span style=color:#ff8606> verify your registered mobile number</span> you have entered.<br>If you have <span style=color:#ff8606>successfully</span> given the NEO olympiad 2022 and still not able to get your certificate, mail your query at <a style=color:#ff8606;text-decoration:none href=mailto:neo.pr.ecellvnit@gmail.com> neo.pr.ecellvnit@gmail.com</a><br><br>Join the community to know more about entrepreneurship";?><br><br>
